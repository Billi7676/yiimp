...
<table cellspacing=20 width=100%>
  <tr>
    <td valign=top width=40%>
      <!--  -->
      <img src="/images/Absolute-Text-With-Logo-Black.png" width="520" height="125" title="Absolute" />
      <br>
      <br>
      ...
      <div class="main-left-box">
        ...
        <div class="main-left-inner">
          <ul>
            <li><p class="main-left-box" style='padding: 3px; font-size: .8em; background-color: #ffffee; font-family: monospace;'> -o stratum+tcp://<?= YAAMP_STRATUM_URL ?>:&lt;PORT&gt; -u &lt;WALLET_ADDRESS&gt; [-p &lt;OPTIONS&gt;]</p></li>
